/**
  ...
  *                   Pure slave — never transmits unsolicited.
  ******************************************************************************
  */
...
#define CAN_REFEREE_QUERY_ID       0x200   /* Rx: referee requests shoot data   */
#define CAN_BOARD_RESPONSE_ID      0x300   /* Tx: board → shoot status report   */
#define CAN_LED_CMD_ID             0x400   /* Rx: LED control / team / heat     */
